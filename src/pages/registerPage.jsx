...
function RegisterPage() {
  ...
  const schema = yup.object().shape({ // объект валидации
    ...
    name: yup.string().trim().required(t('errors.required')).min(3, t('errors.username')),
    secondName: yup.string().trim().required(t('errors.required')).min(3, t('errors.username')),
    thirdName: yup.string().trim().required(t('errors.required')).min(3, t('errors.username'))
  });
                ...
                {({
                  ...
                  <Form className="col-12 col-md-6 mt-3 mt-mb-0" noValidate onSubmit={handleSubmit}> { /* отправка формы */ }
                    ...
                    <Form.Floating className="mb-4">
                      ...
                      />
                      <label className="form-label" htmlFor="name">{t('registrationForm.name')}</label>
                      <Form.Control.Feedback type="invalid" tooltip>
                        {errors.name}
                      </Form.Control.Feedback>
                    </Form.Floating>
                    <Form.Floating className="mb-4">
                      ...
                      />
                      <label className="form-label" htmlFor="secondName">{t('registrationForm.secondName')}</label>
                      <Form.Control.Feedback type="invalid" tooltip>
                        {errors.secondName}
                      </Form.Control.Feedback>
                    </Form.Floating>
                    <Form.Floating className="mb-4">
                      ...
                      />
                      <label className="form-label" htmlFor="thirdName">{t('registrationForm.thirdName')}</label>
                      <Form.Control.Feedback type="invalid" tooltip>
                        {errors.thirdName}
                      </Form.Control.Feedback>
                    </Form.Floating>
